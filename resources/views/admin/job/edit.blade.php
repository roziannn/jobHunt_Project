                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="company" id=""
                                            ...
                                            @foreach ($companies as $item)
                                                <option @selected($item->id === $job->company_id) value="{{ $item->id }}">
                                                    {{ $item->name }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="category" id=""
                                            ...
                                            @foreach ($categories as $item)
                                                <option @selected($item->id === $job->job_category_id) value="{{ $item->id }}">
                                                    {{ $item->name }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="country" id=""
                                            ...
                                            @foreach ($countries as $item)
                                                <option @selected($item->id === $job->country_id) value="{{ $item->id }}">
                                                    {{ $item->name }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="state" id=""
                                            ...
                                            @foreach ($states as $item)
                                                <option @selected($item->id === $job->state_id) value="{{ $item->id }}">
                                                    {{ $item->name }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="city" id=""
                                            ...
                                            @foreach ($cities as $item)
                                                <option @selected($item->id === $job->city_id) value="{{ $item->id }}">
                                                    {{ $item->name }}</option>
                                            @endforeach
                                        </select>
                                        ...
                                        <div class="col-2">
                                            <div class="form-group">
                                                <input @checked($job->salary_mode === 'range') type="radio"
                                                    onclick="salaryModeChange('salary_range')" id="salary_range"
                                        ...
                                        <div class="col-2">
                                            <div class="form-group">
                                                <input @checked($job->salary_mode === 'custom') type="radio"
                                                    onclick="salaryModeChange('custom_salary')" id="custom_range"
                                                    class="from-control {{ hasError($errors, 'salary_mode') }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="salary_type" id=""
                                            ...
                                            @foreach ($salaryType as $item)
                                                <option @selected($item->id === $job->salary_type_id) value="{{ $item->id }}">
                                                    {{ $item->name }}</option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="experience" id=""
                                            ...
                                            @foreach ($experiences as $item)
                                                <option @selected($item->id === $job->job_experience_id) value="{{ $item->id }}">
                                                    {{ $item->name }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="job_role" id=""
                                            ...
                                            @foreach ($jobRoles as $item)
                                                <option @selected($item->id === $job->job_role_id) value="{{ $item->id }}">
                                                    {{ $item->name }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="education" id=""
                                            ...
                                            @foreach ($educations as $item)
                                                <option @selected($item->id === $job->job_education_id) value="{{ $item->id }}">
                                                    {{ $item->name }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="job_type" id=""
                                            ...
                                            @foreach ($jobTypes as $item)
                                                <option @selected($item->id === $job->job_type_id) value="{{ $item->id }}">
                                                    {{ $item->name }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="tags[]" id="" multiple
                                            ...
                                            @foreach ($tags as $item)
                                                {{-- in_array will compare the selectedTag --}}
                                                <option @selected(in_array($item->id, $selectedTags)) value="{{ $item->id }}">
                                                    {{ $item->name }}</option>
                                            @endforeach
                                        </select>
                                ...
                                @php
                                    ...
                                    foreach ($benefits as $item) {
                                        $benefitNames[] = $item->benefit->name;
                                    }
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="skills[]" id="" multiple
                                            ...
                                            @foreach ($skills as $item)
                                                <option @selected(in_array($item->id, $selectedSkills)) value="{{ $item->id }}">
                                                    {{ $item->name }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select name="receive_application" id=""
                                            ...
                                            <option @selected($job->apply_on === 'app') value="app">On Platform </option>
                                            <option @selected($job->apply_on === 'email') value="email">On your Email </option>
