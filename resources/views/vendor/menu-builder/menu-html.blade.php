                                                                ...
                                                                <div class="customlinkdiv" id="customlinkdiv">
                                                                    ...
                                                                    <p id="menu-item-name-wrap">
                                                                        <label class="howto"
                                                                            ...
                                                                            <span>Pages</span>&nbsp;
                                                                            @php
                                                                                $customPages = \App\Models\CustomerPageBuilder::all();
                                                                            @endphp
                                                                            <select name="" id=""
                                                                                class="menu-builder-select regular-text menu-item-textbox input-with-default-title"
                                                                                style="color: black !important; padding: 6px !important;">
                                                                                <option value="">Choose</option>
                                                                                <option value="/">Home Page
                                                                                </option>
                                                                                <option value="/companies">Companies
                                                                                    Page</option>
                                                                                <option value="/candidates">Candidates
                                                                                    Page</option>
                                                                                <option value="/pricing">Pricing Page
                                                                                </option>
                                                                                <option value="/jobs">Jobs Page
                                                                                </option>
                                                                                <option value="/blogs">Blogs Page
                                                                                </option>
                                                                                <option value="/about-us">About Us Page
                                                                                </option>
                                                                                <option value="/contact">Contact Page
                                                                                </option>
